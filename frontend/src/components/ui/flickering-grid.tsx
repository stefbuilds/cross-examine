// Flickering grid canvas backdrop (21st.dev). Preserved as supplied; used only as a
// decorative, pointer-events-none layer. Honors reduced-motion by leaving the grid
// static (the paused animation renders a single frame).
"use client";
