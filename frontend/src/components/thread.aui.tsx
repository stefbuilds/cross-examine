  ...
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col px-2">
      ...
      <p className="mt-3 text-sm leading-6 text-muted-foreground">
        Paste a public Python GitHub PR, or give me a repository and its base and head refs.
        To try it without an API key, send “Run offline hero demo”.
      </p>
    </div>
  );
};
      ...
      <ComposerPrimitive.AttachmentDropzone asChild>
        ...
        >
          ...
          <ComposerPrimitive.Input
            placeholder="Paste a GitHub PR, describe a comparison, or type Run offline hero demo"
        ...
        <MessagePrimitive.GroupedParts groupBy={groupBy}>
          {({ part, children }) => {
            switch (part.type) {
              ...
              case "indicator":
                return (
                  <div data-slot="aui_assistant-message-indicator" className="py-1">
                    <LoadingState label="Thinking" variant="Dots" />
                  </div>
                );
              default:
...
const AssistantActionBar: FC = () => {
  return (
    ...
    >
      ...
      {/* Saved investigations are append-only: regeneration must not rerun tools. */}
...
const UserActionBar: FC = () => {
  return (
    ...
    >
      <ActionBarPrimitive.Copy asChild>
        <TooltipIconButton tooltip="Copy message" className="aui-user-action-edit">
          <CopyIcon />
        </TooltipIconButton>
      </ActionBarPrimitive.Copy>
    </ActionBarPrimitive.Root>
